...
# 讀取資料
missing_df = pd.read_csv('L1_missing.csv', parse_dates=['Date'])
agg_df = pd.read_csv('L1_aggregated.csv', parse_dates=['DateTime'])
...
agg_df.to_csv('L1_aggregated_fill1.csv', index=False)
missing_df.to_csv('L1_missing_fill1.csv', index=False)
